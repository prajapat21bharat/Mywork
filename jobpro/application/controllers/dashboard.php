...
{	
	...
	public function profile()
	{
		...
		if($id = $this->session->userdata('id'))
		{
				...
				$data['language_data'] = $this->user_model->get_sql_select_data('languages');
			/*		echo"<pre>";
					print_r($data);
					exit;  */
				 $where=array(
...
// -------------------------------------------Update education-----------------------------------------------------------				
	...
	public function edu_update()
	{
				...
				's_date' => trim($this->input->post('s_date')),
				'e_date' => trim($this->input->post('e_date')),
				'degree' => trim($this->input->post('degree')),
				'field_of_study' => trim($this->input->post('field_of_study')),
				'grade' => trim($this->input->post('grade')),
				'description' => trim($this->input->post('description_edu'))
							  );
	...
	// --------------------------------------- Add education---------------------------------------------------------------				
		...
		/*	echo"<pre>";
			...
			exit; */
				...
				'from_month' => trim($this->input->post('from_month')),
				's_year' => trim($this->input->post('s_year')),
				'to_month' => trim($this->input->post('to_month')),
				'e_year' => trim($this->input->post('e_year')),
				'description' => trim($this->input->post('description_work'))
	    ...
	    public function cert_update()
		{
				...
				{ 
					...
					exit; */
					 ...
					 $field=array(
				'uid'=>$this->session->userdata('id'),
				'cert_name' => trim($this->input->post('cert_name')),
				'cert_authority' => trim($this->input->post('cert_authority')),
				'license_number' => trim($this->input->post('license_number')),
				'cert_url' => trim($this->input->post('cert_url')),
				's_date' => trim($this->input->post('s_date')),
				'from_month' => trim($this->input->post('from_month')),
				'e_date' => trim($this->input->post('e_date')),
				'to_month' => trim($this->input->post('to_month'))
