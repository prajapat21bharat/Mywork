...
<!--wrapper start-->
<div id="wrapper_node1">
<!--header start-->
<div id="header_node1">
<div class="inner_header_node1">

<div class="logo_node1"><a href="<?php  echo site_url().'/start'?>"><img src="<?php echo base_url()?>ast/images/logo 8.jpg" ="logo" /></a></div>
<div class="nav_node1">

<a href="<?php  echo site_url().'/account'?>"><div class="account_node1">Create Account</div></a>
<a href="<?php  echo site_url().'/mentors'?>"><div class="mentor_node1">Find Mentor</div></a>
<!--<a href="team.html"><div class="team_node1">Consult with Them</div></a>-->
<a href="<?php  echo site_url().'/skill'?>"><div class="skill_node1">Skills Improved</div>
</a>

</div>

<div class="login_res">
<a href="<?php  echo site_url().'/login'?>"><div class="login"><p>Login</p></div></div>
</a>
<a href="<?php  echo site_url().'/account'?>"><div class="register"><p>Register</p></div>
</a>
