				...
				<form method="post" id="category-form" onsubmit="return valid_category()">
					<table align="center" cellspacing="5px" cellpadding="5px" style="background:#EEEEEE;margin-bottom:15px">
						<tr>
							...
							<td class="tbl_add_cate"><input type="text" name="category" value="<?php echo $category;?>" id="category" class="txt_popup" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Category Name'" placeholder="Category Name" />
								<span id="err_category" style="display:none;" class="error" ></span>
							</td>
							<td class="tbl_add_cate"><input type="submit" class="bttn_popup" name="addcategory" id="addcategory" value="Add"/></td>
						</tr>
					</table>
				</form>
			</div>
