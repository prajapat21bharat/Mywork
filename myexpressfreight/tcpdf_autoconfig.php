...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', ' ultimatewellnessllc');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', ' ultimatewellnessllc');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', ' ultimatewellnessllc');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by  ultimatewellnessllc -");
}
