...
<script>
	function valid_category()
	{
		...
		if(subcategory=="")
		{
			...
			document.getElementById("err_subcategory").innerHTML = "Please Select Sub Category Name";
			a=1;
		}
		else
		{
				document.getElementById("err_subcategory").style.display = "none";
		...
		if(child_categoryname=="")
		{
			...
			document.getElementById("err_child_category").innerHTML = "Please Enter Child-Category Name";
			a=1;
		}
		else
		{
				document.getElementById("err_child_category").style.display = "none";
		...
		<div class="content-data">
			<div class="addcate">
				...
				<div class="col-sm-9 col-md-9">
					<select id="sub_category" name="sub_category"  class="form-control required popup_select">
						<option value="" >Select Category</option>
							<?php
								...
								{ 	
									if($getchildcategory[0]['sub_cate_id']==$row['id'])
									{
										$select="selected";
									}
									else
					...
					<input type="hidden" value="<?php echo $getchildcategory[0]['id'];?>" id="updateidid" name="updateidid"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-9">
						<input type="text" name="child_categoryname" value="<?php echo $getchildcategory[0]['child_name'];?>" id="child_categoryname" class="txt_popup form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Category Name'" placeholder="Child Category Name" />
				...
				<div class="form-group">        
					<div class="col-sm-offset-3 col-sm-9 ">
						<input type="submit" class="form_btn" name="updatechildcategory" id="updatechildcategory" value="Update"/>
					</div>
				</div>
			...
			<?php
				...
				?>
						<tr>
							...
							<td><a onClick="return doconfirm()" href="<?php echo site_url() ?>admin/delete_childcategory/<?php echo $row['id'] ?>">
