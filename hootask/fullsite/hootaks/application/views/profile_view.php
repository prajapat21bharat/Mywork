...
<legend> Profile Detail </legend>
	...
	<div class="percentbar" style="width: 503px;">
			<div class ="<?php echo $class ?>" style="width:<?php echo round($percentage * $total_points)/$max; ?>px;">
...
<tr>
<td>Languages</td>
<td><input type="text" class="txt_popup"name="language" class = "txt_popup" value="<?php echo $userdata[0]['language']?>" ></td>
</td>
</tr>
...
?>
	<div class="edit">
		<ul>
			<li><a href="<?php echo site_url() ?>/dashboard/edu_update/<?php echo $row['id'] ?>
" class='click_edit_edu' >Edit <?php echo $row['id']?> </a></li>
		</ul>
		</div> 
...
<div class='popup_add_skill'>
<div class='content'>
<img src='<?php echo base_url().'/ast/images/x.png'?>' style="border-radius:50%" alt='quit' class='x' id='x' />
<p>

<div class="form">
	<div class="form-header"><span class="popup_heading"><h3>Add New Skill</h3></span></div>
	<div class="form-data">


<form method="post" action="<?php echo site_url('dashboard/skill_add'); ?>">
<table align="left">
	

<tr>
<td> Skills :-</td>
<td><input type="text" class="txt_popup"name="skill" placeholder="Ex:- PHP." value="<?php echo $skill?>"></td>
</tr>

<tr>
<td colspan="4" align="right"><input type="submit" name="submit_add_skill" value="Add" > </td>
</tr>
