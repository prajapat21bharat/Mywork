		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Ethnicities > </span><a href="<?php echo site_url('admin/viewethnicity') ?>">View Ethnicities</a>
				</div>
				<div class="ad-haeding">
						<h2>View Ethnicities</h2>
                    </div>
                    </hr>
                </div>
                </div>
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 227px;" aria-label="Browser: activate to sort column ascending">Ethnicity</th>
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><?php print $ethnicity['ethnicity'];?></td>
											<td class=""><a href="#"><?php print $status;?></a></td>
											<td class=""><a href="<?php echo site_url('admin/editethnicity').'/'.$ethnicity['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/delete_ethnicity').'/'.$ethnicity['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
