		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				...
				<div class="breadcrums">
					<span>Brands > </span><a href="<?php echo site_url('admin/addbrand') ?>">Add Brand</a>
				</div>
                     <h2>Add Brand</h2>
                     <?php
						if (isset($message))
                 ...
                 <div class="row">
					<div class="col-md-12">
						...
						<form action="<?php echo site_url()?>admin/addbrand" method="post">
							...
							<div class="col-md-10">
							  <div class="form-group">
								<input type="text" placeholder="Brand Name" id="brand" class="form-control" value="<?php echo set_value('brand'); ?>" name="brand" onblur="this.placeholder = 'Brand Name'" onfocus="this.placeholder = ''">
							  </div>
							</div>
