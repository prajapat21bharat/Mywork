		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Resources > </span><a href="<?php echo site_url('admin/view_resource_category') ?>">View Categories</a>
				</div>
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><?php print $category['name'];?></td>
											<td class=""><a href="#"><?php print $status;?></a></td>
											<td class=""><a href="<?php echo site_url('admin/edit_resource_category').'/'.$category['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/delete_resource_category').'/'.$category['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
