		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					...
					<a href="<?php echo site_url()?>admin/featuredimage/<?php print @$allimages[0]['user_id']; ?>">View Featured Image </a>
				</div>
					...
					<div class="panel panel-default">
						...
						?>
							<div class="feature-data">
								<p class="col-sm-12">Stylist Name : </span><span class="stylistname"><strong><?php echo $allimages[0]['firstname'].' '.$allimages[0]['lastname'] ?></strong></p>
								<form method="post" action="<?php echo site_url('admin/delete_featured')?>" >
									<div class="col-sm-3">
									...
									<div class="col-sm-9">
										<input type="hidden" name="s_uid" value="<?php print @$allimages[0]['user_id']; ?>" >
										<input type="submit" name="delete_public" value="Delete" class="" >
									</div>
