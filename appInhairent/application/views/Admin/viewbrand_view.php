		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Brands > </span><a href="<?php echo site_url('admin/viewbrand') ?>">View Brands</a>
				</div>
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><?php print $brand['name'];?></td>
											<td class=""><a href="#"><?php print $status;?></a></td>
											<td class=""><a href="<?php echo site_url('admin/editbrand').'/'.$brand['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/deletebrand').'/'.$brand['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
