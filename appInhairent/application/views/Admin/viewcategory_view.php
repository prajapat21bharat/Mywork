		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Product Categories > </span><a href="<?php echo site_url('admin/viewcategory') ?>">View Categories</a>
				</div>
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><a href="<?php echo site_url('admin/editcategory').'/'.$category['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/deletecategory').'/'.$category['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
