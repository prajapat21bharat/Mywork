		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Hair Colors > </span><a href="<?php echo site_url('admin/addcolor') ?>">Add Color</a>
				</div>
				<div class="ad-haeding">
                 ...
                 <div class="row">
					<div class="col-md-12">
						...
						<form action="<?php echo site_url()?>admin/addcolor" method="post">
							...
							<div class="col-md-10">
							  <div class="form-group">
									<input type="text" placeholder="Color Name" id="color" class="form-control" value="<?php echo set_value('color'); ?>" name="color" onblur="this.placeholder = 'Color Name'" onfocus="this.placeholder = ''">
							  </div>
							</div>
