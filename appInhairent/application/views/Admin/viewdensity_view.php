		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Densities > </span><a href="<?php echo site_url('admin/viewdensity') ?>">View Densities</a>
				</div>
				<div class="ad-haeding">
						<h2>View Densities</h2>
                    </div>
                    </hr>
                </div>
                </div>
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<thead>
										<tr role="row">
											...
											<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 227px;" aria-label="Browser: activate to sort column ascending">Density</th>
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><?php print $density['density'];?></td>
											<td class=""><a href="#"><?php  print $status;?></a></td>
											<td class=""><a href="<?php echo site_url('admin/editdensity').'/'.$density['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/delete_density').'/'.$density['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
