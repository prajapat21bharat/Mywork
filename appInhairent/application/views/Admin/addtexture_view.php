		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Textures > </span><a href="<?php echo site_url('admin/addtexture') ?>">Add Texture</a>
				</div>
				<div class="ad-haeding">
                 ...
                 <div class="row">
					<div class="col-md-12">
						...
						<form action="<?php echo site_url()?>admin/addtexture" method="post">
							...
							<div class="col-md-10">
							  <div class="form-group">
								<input type="text" placeholder="Texture Name" id="texture" class="form-control" value="<?php echo set_value('texture'); ?>" name="texture" onblur="this.placeholder = 'Texture Name'" onfocus="this.placeholder = ''">
							  </div>
							</div>
