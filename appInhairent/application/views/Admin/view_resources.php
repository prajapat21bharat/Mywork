		...
		<div class="row">
			<div class="col-sm-12 col-xs-12 left-space-r">
				<div class="breadcrums">
					<span>Resource > </span><a href="<?php echo site_url('admin/resources') ?>">View Resources</a>
				</div>
				<div class="ad-haeding">
                 ...
                 <!-- /. ROW  -->
               <div class="message" style="text-align:center;"><?php  if($this->session->flashdata('Logmsg'))   echo  $this->session->flashdata('Logmsg'); ?></div> 
			<!---->
			<div class="row">
				<div class="col-md-12">
					<!-- Advanced Tables -->
								...
								<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
									...
									<thead>
										<tr role="row">
											...
											<th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 227px;" aria-label="Browser: activate to sort column ascending">Description</th>
											<th class="" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 227px;" aria-label="Browser: activate to sort column ascending">Resource Type</th>
									...
									<tbody>
										...
										<tr class="gradeA <?php echo $class; ?>">
											...
											<td class=""><?php print $resources['title'];?></td>
											<td class=""><?php print $resources['description'];?></td>
											<td class=""><?php print $resources['resource_type'];?></td>
											<td class=""><?php print $status;?></td>
											<td class=""><a href="<?php echo site_url('admin/editresource').'/'.$resources['id']?>">Edit</a></td>
											<td class=""><a href="<?php echo site_url('admin/delete_resources').'/'.$resources['id']?>" onclick="return doconfirm()">Delete</a></td>
										</tr>
										<?php
											}
										?>
