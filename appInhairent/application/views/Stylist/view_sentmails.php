						...
						<div id="myTabContent" class="tab-content">
							<!----Section for Main content start ---->
								...
								<div class="row">								
										...
										<div role="grid" class="dataTables_wrapper form-inline" id="dataTables-example_wrapper">
											...
											<thead>
												<tr role="row">
													...
													<th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 227px;" aria-label="Browser: activate to sort column ascending">Email Subject</th>
											...
											<tbody>
												<?php
													$i=0;
													foreach($email_archive as $archive)
													{
														if($i%2==0)
														{
															$class="even";
														...
														$i++;
															...
															$datetime=strtotime($archive['sentdate']);
												...
												<tr class="gradeA <?php echo $class; ?>">
													...
													<td class=""><?php print $archive['sent_subject'];?></td>
													<!--<td class="template_content_row"><?php // print $archive['sent_content'];?></td>  -->
													<td class=""><?php print $date; ?></td>
													<td class=""><a href="<?php echo site_url().'stylist/message/'.$archive['sent_id']; ?>"><i class="fa fa-eye"></i> View</a></td>
												</tr>
												<?php
													}
												?>
									...
									<div class="row">
										<div class="col-md-12">
											<a href="<?php echo site_url().'stylist/sent_mails'; ?>">Back to Email</a>
										</div>
									</div>
									
									<div class="row top-padder">
											<div class="col-md-12 template_content_row "><?php print $sent_message[0]['sent_content']; ?></div>
									</div>
									<?php
										}
									?>
