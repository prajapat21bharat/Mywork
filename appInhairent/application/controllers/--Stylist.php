...
$basepath=base_url();
$message='<table style="height: 140px;" width="683">
	<tbody>
		<tr>
			<td style="text-align: center;"><img src="http://server.ntftechnologies.com/inhairent/assets/js/tinymce/plugins/jbimages/ci/assets/uploads/inhairent.png" alt="" /></td>
		</tr>
		<tr>
			<td>
				<h3>Hi '.$data['all_email_data'][0]['firstname'].' '.$data['all_email_data'][0]['lastname'].',</h3><br>Thank You for selecting products. <br><br> Details of Product You have selected is :<br><br><br>
			</td>
		</tr>
		
		<tr>
			<td>
				<table cellspacing="0" cellpadding="0" border="0" width="600" padding:3px;>
			...
			/*		$message.=	'<table cellspacing="0" cellpadding="0" border="0" width="600" padding:3px;>
								...
								foreach($data['all_email_data'] as $emaildata)
								{
									$message.=	'<tr style="border-bottom:1px solid #68268A !important;">
													...
													<td><img src='.$basepath.'assets/product/thumbnails/150x150/'.$emaildata['p_image'].' style="height:80px;width:80px;" /></td>
												</tr>';
									$i++;
								}
		...
		<tr>
			<td>
				<table style="height: 50px;" width="666">
					<tbody>
						<tr>
							<td><img src="'.$basepath.'assets/js/tinymce/plugins/jbimages/ci/assets/uploads/outline-dark-facebook-48.png" alt="" width="30" height="30" /><a title="Facebook" href="https://www.facebook.com/inhairent" target="_blank">Facebook</a></td>
							<td><img src="'.$basepath.'assets/js/tinymce/plugins/jbimages/ci/assets/uploads/outline-dark-youtube-48.png" alt="" width="30" height="30" /><a title="YouTube" href="https://www.youtube.com/channel/UCoBf5lX0caMyzzc9L-SQALg/feed? view_as=public&amp;amp;sub_confirmation=1&amp;amp;feature=iv&amp;amp;src_vid=HxDSt0gsOj4&amp;amp;annotation_id=annotation_3050169615" target="_blank">YouTube</a></td>
							<td><img src="'.$basepath.'assets/js/tinymce/plugins/jbimages/ci/assets/uploads/outline-dark-pinterest-48.png" alt="" width="30" height="30" /><a title="Pinterest" href="http://www.pinterest.com/inhairent" target="_blank">Pinterest</a></td>
							<td><img src="'.$basepath.'assets/js/tinymce/plugins/jbimages/ci/assets/uploads/outline-dark-link-48.png" alt="" width="30" height="30" /><a title="Website" href="http://www.inhairent.com" target="_blank">http://www.inhairent.com</a></td>
						</tr>
					</tbody>
				</table>
			</td>
		...
		<tr>
			<td><em>Copyright &copy; '.date("Y").' &nbsp;All rights reserved.</em> <br /><br /><strong>Our mailing address is:</strong> <br /><br /><a class="utilityLink" href="*|UNSUB|*">unsubscribe from this list</a>&nbsp;&nbsp;&nbsp; <a class="utilityLink" href="*|UPDATE_PROFILE|*">update subscription preferences</a>&nbsp; </td>
		</tr>
	</tbody>
</table>';
