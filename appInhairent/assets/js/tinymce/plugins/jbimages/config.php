...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = 'http://server.ntftechnologies.com/inhairent/assets/js/tinymce/plugins/jbimages/ci/assets/uploads'; // Relative to domain name
	
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	$config['upload_path'] = 'http://server.ntftechnologies.com/inhairent/assets/js/tinymce/plugins/jbimages/ci/assets/uploads'; // Physical path. [Usually works fine like this]
