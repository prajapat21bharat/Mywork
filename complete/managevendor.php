...
<div id="wrapper">
  ...
  <a href="vendors.php" ><img src="images/backk.png"> </a>
...
<form name="form1" method="post" onSubmit="return valid()" enctype="multipart/form-data">
   <fieldset class="form">
      ...
      <p>
         <label for="client_email"><span id="sEmail" style="color:red;font-size:16px; font-weight:bold">* </span>E-Mail:</label>
         <input name="client_email" type="text" id="client_email" /><span id="smail" style="color:red; font-weight:bold"></span>
         <input name="userlevel" type="hidden" id="userlevel" value="1">
      </p>
      <p>
         <label for="client_fname"><span id="SFName" style="color:red;font-size:14px; font-weight:bold">* </span>First Name:</label>
         <input name="client_fname" type="text" id="client_fname"  /><span id="SFname" style="color:red; font-weight:bold"></span>
      </p>
      <p>
         <label for="client_lname">Last Name:</label>
         <input name="client_lname" type="text" id="client_lname"  /><span id="SLname" style="color:red; font-weight:bold"></span>
      </p>
	  <p>
         <label for="client_password"><span id="SPassword" style="color:red;font-size:14px;">* </span>Password:</label>
         <input name="client_password" type="password" id="client_password"  /><span id="spassword" style="color:red; font-weight:bold"></span>
      </p>    
     <!-- <p>
      ...
      <p>
         ...
         <input name="client_city" type="text" id="client_city"  /><span id="Scity" style="color:red; font-weight:bold"></span>
      </p>
	  <p>
         <label for="client_contact"><span id="SContact" style="color:red;font-size:14px; font-weight:bold">* </span>Contact No.:</label>
         <input name="client_contact" type="text" id="client_contact"  /><span id="Scontactno" style="color:red; font-weight:bold"></span>
      </p>      
	        
	  <p>
         <label for="client_zipcode">Zipcode:</label>
         <input name="client_zipcode" type="text" id="client_zipcode"  /><span id="Szipcode" style="color:red; font-weight:bold"></span>
      </p>
	  <p>
         <label for="client_website_url">Website Url:</label>
         <input name="client_website_url" type="text" id="client_website_url"  /><span id="Surl" style="color:red; font-weight:bold"></span>
      </p>
	  <p>
         <label for="client_photo">Select Image:</label>
         <input name="client_photo" type="file" id="client_photo" style="height:30px"  />
		 <span id="Sphoto" style="color:red; font-weight:bold"></span>
      </p>
...
$files="http://testgrubtracker.canopussystems.com/images/". $filename;
//----				
				...
				//$photo=$_FILES["client_photo"];
                 ...
                 $sql="select * from userregistration where emailid='$email'";		
						...
						if($result)
						{
							...
							{
									$sql="INSERT INTO userregistration(emailid,firstname,lastname,password,phoneno,city,zipcode,website,image,usertype)
					values('$email','$firstname','$lastname','$password','$contactno','$city','$zipcode','$website','$files','1')";
...
$message .='<tr>';
$message .='<td height="25" colspan="2" align="left" valign="middle" class="topfont colorGray"><strong>Dear,'.$username.' Your GrubTracker Account Created Successfully.</strong></td>';
$message .='</tr>';
$message .='<tr>';
$message .='<td align="left" colspan="2" valign="middle" class="topfont colorGray">Your UserName '.$username.'</td>';
$message .='</tr>';
$message .='<tr>';
...
$message .='</table>';						
						$email_to = $email;
						$email_subject="GrubTracker Registration";					
						$email_from = "canopus.testing@gmail.com";
